...
for func in activation_func:
    for i in range(20):
        ...
        model = learn.model("BreakoutDeterministic-v4", TARGET_UPDATE_FREQUENCY=5)
        #model = learn.model("Breakout-v0", DISCOUNT_RATE=params[0], REPLAY_MEMORY=params[1], BATCH_SIZE=params[2], TARGET_UPDATE_FREQUENCY=params[3], h_size=params[4], l_rate=params[5], activation=params[6], MAX_EPISODES=500)
