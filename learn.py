...
class model:
    ...
    def plot(self, params, episode_data, step_data):
        ...
        plt.show()
        fig = plt.gcf()
        fig.savefig(fname="Discount rate: {:.3f} Replay Memory : {} Batch size: {} Target Update Frequency: {} Hidden layer size: {} Learning rate: {} Activation function: {} Episodes that needed to train: {}".format(params[0], params[1], params[2], params[3], params[4], params[5], params[6], params[7]), format="png")